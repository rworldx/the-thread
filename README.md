...
content/characters.ts      the 699 people, hand-written; appearances are NOT
...
699 people. Their **appearances are derived, never typed**: a character is in a
...
`lib/power.ts` ranks all 699, and the /characters page sorts by it. DERIVED,
NOT TYPED, for the reason appearances are: a `powerRank` column would be 699
