...
| Characters | 692, appearances derived from cast |
...
transformation, and 216 posters plus 692 portraits plus galleries and search
...
content/characters.ts      the 692 people, hand-written; appearances are NOT
...
692 people. Their **appearances are derived, never typed**: a character is in a
...
`lib/power.ts` ranks all 692, and the /characters page sorts by it. DERIVED,
NOT TYPED, for the reason appearances are: a `powerRank` column would be 692
