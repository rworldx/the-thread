...
| Characters | 686, appearances derived from cast |
...
transformation, and 216 posters plus 686 portraits plus galleries and search
...
content/characters.ts      the 686 people, hand-written; appearances are NOT
...
686 people. Their **appearances are derived, never typed**: a character is in a
...
`lib/power.ts` ranks all 686, and the /characters page sorts by it. DERIVED,
NOT TYPED, for the reason appearances are: a `powerRank` column would be 686
